...
const ReelFeed = ({ items = [], onLike, onSave, emptyMessage = 'No videos yet.' }) => {
  ...
  async function openComments(item) {
    ...
    try {
      ...
      const res = await axios.get(
        `https://foodstream-backend.onrender.com/api/food/comment/${item._id}`,
        {
  ...
  async function sendComment() {
    ...
    try {
      ...
      await axios.post(
        "https://foodstream-backend.onrender.com/api/food/comment",
        {
      ...
      const res = await axios.get(
        `https://foodstream-backend.onrender.com/api/food/comment/${selectedFood._id}`,
        {
          withCredentials: true
        }
      )
